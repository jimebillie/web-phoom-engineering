...
<div class="content">
    ...
    <div class="box-main">
        ...
        <div class="bnt-back-01"><a href="project.php">BACK</a></div>
...
<script>
    async function callProject() {
        ...
        if (res.length > 0) {
            res.map((v, i) => {
                document.querySelector(".title-all").textContent = v.name_project
                document.querySelector(".year-detail").textContent = v.year
