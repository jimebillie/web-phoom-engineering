        ...
        if (document.getElementById("summernote1").value === "") {
            ...
            const callAPI = async () => {
                ...
                if (res.status === 200) {
                    setTimeout(() => {
                        displayLoad.style.display = "none";
                        document.getElementById("name_plant").value = null
        ...
        if (res.length > 0) {
            ...
            res.map((v, i) => {
                ...
                edit.addEventListener("click", (e) => {
                    window.location.href = "?p=edit_gypsumplant&id=" + v.id + "&name=" + v.name_plant;
                });
                td4.append(del)
                td4.append(edit)
                tr.appendChild(td1);
