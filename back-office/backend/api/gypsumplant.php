...
require_once("../controller/gypsumplant.php");
$controller = new gypsumplant();

if (isset($_POST['api'])) {
    switch ($_POST['api']) {
        case "save_main":
            $controller->save_main($_POST['name_plant'], $_FILES['img'], $_POST['detail']);
            break;
        case "show_main":
        ...
        case "editGypsumById":
            ...
            $controller->editGypsumById($_POST['id'], $_POST['name_plant'], $_FILES['img'], $_POST['detail']);
            break;
        case "saveImgOther":
